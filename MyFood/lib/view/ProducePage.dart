...
class _ProducePageState extends State<ProducePage> {
  ...
  Future getPosts() async {
    ...
    QuerySnapshot qn =
    await db.collection("Users").doc(uid).collection("Drawer").where("Type", isEqualTo: "Produce").get();
  ...
  /* public void getMultipleDocs(){
    FirebaseFirestore.instance
          .collection("Users")
          .doc("Username02")
          .collection("Drawer").whereEqualTo("Type", "Produce").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
